...
<%@include file="/WEB-INF/jspf/admin/nav.jspf" %>
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      <!-- /.container-fluid -->
<a href="http://localhost:8080/NMCNPM-Nhom16/admin/new-product"><button class="btnab"><i class="fa fa-plus">   Thêm sản phẩm</i></button></a>      <!-- Sticky Footer -->
       <%@include file="/WEB-INF/jspf/admin/addProduct.jspf" %>
